                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-6">
                            ...
                            <div className="bg-gray-50 rounded-lg p-4 mb-6">
                                ...
                                <BotaoPersonalizado
                                    ...
                                    onClick={() => navigate(`/trilha/${carreira.id_carreira}`)}
                                    className="w-full"
                                />
                            </div>
                        </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-6">
                            ...
                            <div className="space-y-3">
                                {ranking && (
                                    <div className={`flex items-center justify-between p-3 rounded-lg border ${ranking.posicao <= 3
                                            ? 'bg-gradient-to-r from-yellow-50 to-yellow-100 border-yellow-200'
                                            : 'bg-gray-50 border-gray-200'
                                        }`}>
                                        <div className="flex items-center gap-3">
                                            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white font-bold text-sm ${ranking.posicao === 1 ? 'bg-yellow-500' :
                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-6">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className={`font-semibold ${carreira.status_jornada === 'Em Andamento' ? 'text-green-600' :
